...
vim.g.dashboard_custom_section = {
  ...
  c = { description = { "  Edit keybindings      " }, command = "edit C:/Users/hou/AppData/Local/nvim/lua/keybindings.lua" },
  d = { description = { "  Edit Projects         " }, command = "edit C:/Users/hou/AppData/Local/nvim-data/project_nvim/project_history", },
